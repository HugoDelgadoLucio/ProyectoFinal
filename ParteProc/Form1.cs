...
namespace PARTE_PROC
{
    ...
    {
        private MySqlConnection connection;  // Conexión a la base de datos MySQL
        private WindowsMediaPlayer player;  // Reproductor de música

        public Form1()
        {
            InitializeComponent();  // Inicializa los componentes del formulario

            // Configuración de reproducción de música al abrir el formulario
            player = new WindowsMediaPlayer();
            player.URL = @"C:\Users\GAEL OVALLE\Documents\UAA 3B\ParteDeProyecto\ParteProc\PistaDeAudio\Ritmo de Maracas.mp3"; // Ruta del archivo de música
        ...
        private void TbxContraseña_Click(object sender, EventArgs e)
        {
        ...
        private void BotonIngresar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string query = "SELECT id, Cuenta, contraseña FROM usuarios";  // Consulta SQL para obtener los datos de los usuarios
        ...
        public void Connect()
        {
            string cadena = "Server=localhost; Database=exportable; User=root; Password=; SslMode=none;";  // Cadena de conexión
            try
            {
        ...
        // Evento clic para pausar la música
        private void ButtonPause_Click(object sender, EventArgs e)
        {
            player.controls.pause();  // Pausa la música
        }

        // Evento clic para reanudar la música
